...
-- product
INSERT INTO online_store.product (name, price, weight, quantity, characteristics) 
VALUES ('Ноутбук Asus T570', 35000, 3, 10, '{}'),
('Ноутбук Acer F20', 30000, 2, 10, '{}'),
('Костюм детский', 2400, 0.5, 3, '{}'),
('Lego конструктор', 2000, 0.8, 5, '{}'),
('Чехол Samsung s6', 400, 0.1, 134, '{}');
